...
# Title: CW Channel A (Tx A to Rx A) loopback at 401.25MHz
...
class pvcw401M25loopbacksobexChA(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CW Channel A (Tx A to Rx A) loopback at 401.25MHz", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CW Channel A (Tx A to Rx A) loopback at 401.25MHz")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pvcw401M25loopbacksobexChA")
...
def main(top_block_cls=pvcw401M25loopbacksobexChA, options=None):
